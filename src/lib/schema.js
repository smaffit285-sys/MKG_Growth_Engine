...
export const EVENT_TYPES = {
  ...
  COMMERCIAL_ACCOUNT_CREATED: 'commercial_account_created',
  MARKET_LEAD_CAPTURED: 'market_lead_captured',
  CHEF_PARTNER_ADDED: 'chef_partner_added',
  SHARPENING_COMPLETED: 'sharpening_completed',
  ...
  UGC_UPLOADED: 'ugc_uploaded',
  SMS_SENT: 'sms_sent',
  RETENTION_CAMPAIGN_TRIGGERED: 'retention_campaign_triggered',
  PROPOSAL_SENT: 'proposal_sent',
  COMMERCIAL_TRIAL_COMPLETED: 'commercial_trial_completed',
...
export const PROOF_TYPES = {
  ...
  YOUTUBE_FEATURE: 'youtube_feature',
